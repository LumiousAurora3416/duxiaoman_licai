  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      >
        ...
        <h1 className="font-hand text-2xl text-[#78350f]">7 天成长之旅</h1>
      ...
      >
        <div className="mb-3 flex items-center justify-between">
          <span className="flex items-center gap-1.5 font-hand text-lg text-[#78350f]">
            <span>🪺</span> 鹅的成长进度
          </span>
        ...
        <div className="mb-3 h-4 w-full overflow-hidden rounded-full bg-[#fef3c7] shadow-[inset_0_2px_4px_rgba(180,120,40,0.15)]">
          <motion.div
        ...
        <div className="flex justify-between text-[11px] text-[#b0a08a]">
          <span>🦢 鹅宝宝</span>
          <span>💰 存入 {amount}</span>
          <span>🥚 日收益 {egg}</span>
        </div>
